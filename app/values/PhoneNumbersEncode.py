...
from app.helper.GenericHelper import replaceDotWithHyphen, removeEveryPunctuation, convertListOfStringsToCapitalString
from app.helper.PrintOutputData import printOutputData
from app.values.AlphaPhrases import generateAllPossiblePhrases,isHaveReplacementsFlagForNumber, firstUnchangedDigit
